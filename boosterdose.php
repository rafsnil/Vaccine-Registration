...
<body>
    <div class="main2">
        ...
        <div class="welcome">
            ...
            <h1>ISSUE <span class="noticemesenpai">BOOSTER DOSE</span> DATE AND VACCINE CENTER</h1>
        ...
        <div class="tablecontainer">
            ...
            <table class="table1">
                ...
                <tbody>
                    ...
                    $sql = "SELECT ri.FullName, sdd.BirthCertificate, sdd.boosterDoseDate
                    FROM second_dose_done sdd, registration_info ri 
                    WHERE sdd.BirthCertificate = ri.BirthCertificate";
                    ...
                    if ($result) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            $boosterdosedate = $row['boosterDoseDate'];

                            echo '<tr>
                              <th>' . $serial . '</th>
                              <td>' . $bcnum . '</td>
                              <td>' .  $fullname . '</td>
                              <td>' . $boosterdosedate . '</td>
                              <td>
                              <button class="btn1"><a href="update_form3.php?updateid=' . $bcnum . '">UPDATE</a></button>
                          </td>
                          </tr>';
                        }
                    }
