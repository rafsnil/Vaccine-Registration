...
if (isset($_POST['submit'])) {
    ...
    $boosterDoseDate = $_POST['boosterDoseDate'];

    $sql1 = "UPDATE second_dose_done
             SET boosterDoseDate = '$boosterDoseDate'
             WHERE BirthCertificate = '$BirthCertificate'";
    $result1 = mysqli_query($db_connection, $sql1);   //boolean return


    $sql2 = "INSERT fullyvaccinated (BirthCertificate)
    ...
    $sql3 = "INSERT vaccine_appointment (BirthCertificate, vaccineSchedule, centerID, dose_order)
            VALUES ('$BirthCertificate','$boosterDoseDate','$centerID','3')";
    ...
    if (($result1 && $result2 && $result3 && $result5) == true) {
        ...
        header("Location: update_form3.php?error=Updated Successfully!");
        exit();
    } else {

        header("Location: update_form3.php?error=COULD NOT BE UPDATED!");
        exit();
    }
}
?>
    ...
    <div class="main2">
        ...
        <div class="container" id="updateform1">
            <form class="f2" method="post">
                ...
                <input type="date" name="boosterDoseDate" required />
